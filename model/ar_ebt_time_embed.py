...
class Attention(nn.Module):
    ...
    def forward(
        ...
        print(f"xq_o shape: {xq_p.shape}, xk_o shape: {xk_p.shape}, freqs_cis shape: {freqs_cis[:original_seqlen].shape} {freqs_cis[2:2 + xq_p.shape[1]]} {freqs_cis[2:original_seqlen+1].shape}")
