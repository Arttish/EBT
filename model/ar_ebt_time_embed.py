...
class Attention(nn.Module):
    ...
    def forward(
        ...
        xq_p, xk_p = apply_rotary_emb(xq_p, xk_p, freqs_cis=freqs_cis[2:original_seqlen+2]) # use 2 since are the next preds and also have time embeddings and thus need to condition on two tokens
